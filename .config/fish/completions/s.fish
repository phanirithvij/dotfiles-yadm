...
function __s_prepare_completions
    ...
    set -l results (__s_perform_completion)
    __s_debug "Completion results: $results"
    ...
    set --global __s_comp_results $results[1..-2]
...
complete -c s -n '__s_prepare_completions' -f -a '$__s_comp_results'
